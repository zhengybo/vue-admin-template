...
(function(win) {
	...
	*/
    ...
    InitDate.prototype = {
        init:function() {
            var that = this, opts = that.config, self = QD(opts.dateCell)[0], elem, devt, even = undefined, target;
            // console.log(even);
            // console.log(target);
	...
	jeDt.creatlink = function(lib){
		...
		link.type = 'text/css';
		link.rel = 'stylesheet';
		link.href = jeDt.getPath +'static/assets/js/lib/jedate/skin/'+ lib + '.css';
		link.id = 'jeDateSkin';
